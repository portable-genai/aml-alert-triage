...
ENV PYTHONDONTWRITEBYTECODE=1 \
    ...
    AMLTRIAGE_PROFILE=gcp \
    AMLTRIAGE_SETTINGS=/app/config/settings.yaml \
    PORT=8080
...
CMD ["sh", "-c", "python -m aml_alert_triage.managed_readiness && exec uvicorn aml_alert_triage.api.app:app --host 0.0.0.0 --port ${PORT:-8080}"]
