...
read
    ...
    bind_profile == local AND profile chosen AND AMLTRIAGE_S2S_TOKEN unset
...
from aml_alert_triage.adapters.local.identity import (
    LocalIdentityAdapter,
)
from aml_alert_triage.adapters.onprem.identity import (
