...
INCOMPLETE_MANAGED_OPERATIONS: tuple[str, ...] = (
    "alert_feed.CloudAlertFeed.fetch_alert",
    "alert_feed.CloudAlertFeed.list_open_alerts",
    "narration.CloudNarration.narrate",
    "retrieval.CloudRetrieval.retrieve",
    "warehouse.CloudWarehouse.fetch_window",
)
